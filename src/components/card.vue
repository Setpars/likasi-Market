...
<template>
 ...
 <div class="card" v-for="vendeur in vendeurs">
    <img :src="vendeur.image" :alt="vendeur.name" :loading="lazy"/>
      <div class="card-content" style="position: relative;">
        ...
        <p style="position: absolute; bottom:-40px;font-weight:bold;">{{ vendeur.adresse }}</p>
      </div>
      <a :href=" `https://wa.me/${vendeur.whatsapp}`"
